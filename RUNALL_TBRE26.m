%% RUNALL_TBRE26 - TBRe26 SUSPENSION LOAD & FATIGUE TOOLCHAIN
...
% ── CONFIGURATION: TBRe26, fixed ─────────────────────────────────────────
% TBRe26 hardware with the LLTD layer ON. This is the VALIDATED
% configuration - it reproduces the team's published member loads
% (maxloads.xlsx) to 0.5% median across all ten design cases.
%
% DUTY CYCLE IS PROVISIONAL: driven by TBRe25 telemetry until TBRe26
% running data exists. Last year's measured g-history on this year's car.
% When 26 data arrives, drop the new CSV in this folder - nothing else
% changes.
%
% For TBRe25 end-to-end (car matches telemetry), use RUNALL_V2.m instead.
VEH  = tbre26_params_V2();
GEOM = tbre26_geometry();
fprintf(['CONFIG: TBRe26 hardware, LLTD layer ON.\n' ...
